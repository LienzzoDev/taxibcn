...
function TaxiBookingForm() {
  ...
  const handleAddressChange =
    (field: "pickupAddress" | "destinationAddress") =>
  ...
  const handleReturnAddressChange =
    ...
    (value: string, placeDetails?: google.maps.places.PlaceResult) => {
      ...
      if (placeDetails?.geometry?.location) {
        ...
        const coordField =
          field === "pickupAddress" ? "pickupCoords" : "destinationCoords";
        setReturnTripData((prev) => ({
          ...prev,
          [coordField]: coords,
        }));
  ...
  const formatPhoneNumber = (value: string) => {
    ...
    if (phoneNumber.startsWith("34") && phoneNumber.length === 11) {
      return `+34 ${phoneNumber.slice(2, 5)} ${phoneNumber.slice(
        5,
        8
      )} ${phoneNumber.slice(8)}`;
    }
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.paymentMethod === "card") {
      ...
      alert(
        "¡Reserva confirmada! El pago se realizará en efectivo al conductor."
      );
    }
  };
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#646464] text-sm leading-relaxed">
              Completa el siguiente formulario, haz tu reserva y tendrás tu
              transporte en tu ubicación cuando lo necesites.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            {/* Contact Data */}
            <div>
              <h3 className="text-[#1c1b1f] text-sm font-medium mb-4">
                Datos de contacto
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => updateField("passengers", value)}
                >
                  <SelectTrigger className="bg-[#f8f8f8] border-[#dcdcdc] text-[#646464] !w-full">
                    <SelectValue placeholder="4 pasajeros" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="1-3">Menos de 4 pasajeros</SelectItem>
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-4">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    updateField("hasLuggage", checked)
                  }
                />
              ...
              {formData.hasLuggage && (
                <Select
                  ...
                  onValueChange={(value) => updateField("luggageCount", value)}
                >
                  <SelectTrigger className="bg-[#f8f8f8] border-[#dcdcdc] text-[#646464] w-full">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    updateField("needsChildSeat", checked)
                  }
                />
            ...
            <div className="flex items-start space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateField("acceptsPrivacy", checked)
                }
                required
              />
              <label
                htmlFor="privacy"
                className="text-[#646464] text-sm leading-relaxed"
              >
                Acepto las{" "}
                <span className="font-medium">Política de privacidad</span> del
                sitio web.
              </label>
            </div>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-[#1c1b1f] text-3xl font-bold">
                    {tripCalculation
                      ? `${
                          showReturnTrip
                            ? (tripCalculation.total * 2).toFixed(2)
                            : tripCalculation.total.toFixed(2)
                        }€`
                      : "---"}
                  </p>
                  {isCalculating && (
                    <Loader2 className="w-4 h-4 animate-spin text-[#ed7e00]" />
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    !tripCalculation ||
                    (showReturnTrip &&
                      (!returnTripData.scheduledDate ||
                        !returnTripData.scheduledTime ||
                        !returnTripData.pickupAddress ||
                        !returnTripData.destinationAddress))
                  }
                >
                  <Lock className="w-4 h-4 mr-2" />
                  {showReturnTrip
                    ? "Reservar ambos viajes"
                    : "Reservar y pagar"}
                </Button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm mt-6">
            <div className="text-center mb-8">
              ...
              <p className="text-[#646464] text-sm">
                Las direcciones se han invertido automáticamente, pero puedes
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-[#1c1b1f] text-sm font-medium mb-4">
                  Programación del viaje de vuelta
                </h3>
                <div className="space-y-4">
                  <Select
                    value={returnTripData.timing}
                    onValueChange={(value) =>
                      setReturnTripData((prev) => ({ ...prev, timing: value }))
                    }
                  >
                    <SelectTrigger className="bg-[#f8f8f8] border-[#dcdcdc] text-[#646464] w-full">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                <div className="mb-3">
                  ...
                  <p>
                    <strong>Desde:</strong> {formData.pickupAddress}
                  </p>
                  <p>
                    <strong>Hasta:</strong> {formData.destinationAddress}
                  </p>
                  {tripCalculation && (
                    <p>
                ...
                {showReturnTrip && (
                  <div className="mb-3 pt-2 border-t border-gray-300">
                    ...
                    <p>
                      <strong>Desde:</strong> {returnTripData.pickupAddress}
                    </p>
                    <p>
                      <strong>Hasta:</strong>{" "}
                      {returnTripData.destinationAddress}
                    ...
                    <p>
                      <strong>Fecha:</strong> {returnTripData.scheduledDate}{" "}
                      {returnTripData.scheduledTime}
                    </p>
                    {tripCalculation && (
                      <p>
            ...
            {tripCalculation && (
              <StripeCheckout
                amount={
                  showReturnTrip
                    ? tripCalculation.total * 2
                    : tripCalculation.total
                }
                bookingData={{
                  ...formData,
                  returnTripData: showReturnTrip ? returnTripData : null,
                }}
